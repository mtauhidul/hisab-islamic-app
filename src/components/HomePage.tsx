  ...
  const features = [
    {
      ...
      description: "Your spiritual journey stays between you and Allah. We store only dates and counts - never personal details.",
      color: "text-emerald-600 dark:text-emerald-400"
    },
    {
      icon: <Moon className="w-6 h-6" />,
      title: "Daily Reflection",
      description: "Track your actions mindfully. Feel genuine regret. Seek sincere repentance through Tawbah.",
      color: "text-blue-600 dark:text-blue-400"
    },
    {
      icon: <TrendingUp className="w-6 h-6" />,
      title: "Spiritual Growth",
      description: "Visualize your journey with meaningful insights. Watch your spiritual awareness grow over time.",
      color: "text-purple-600 dark:text-purple-400"
    },
    {
      icon: <Heart className="w-6 h-6" />,
      title: "Islamic Guidance",
      description: "Built with authentic Islamic principles. Get real scholarly rulings to guide your path.",
          ...
          <Card className="p-6 rounded-xl bg-gradient-to-r from-emerald-50 to-blue-50 dark:from-emerald-950/20 dark:to-blue-950/20 border border-emerald-200 dark:border-emerald-800">
            <CardContent className="p-0">
              ...
              <p className="text-base text-slate-700 dark:text-zinc-300 mb-4 max-w-2xl mx-auto leading-relaxed">
                Built upon the Islamic concept of <strong>Tawbah</strong> (repentance) and <strong>Muhasabah</strong> (self-accountability).
              </p>
          ...
          <Card className="p-6 rounded-xl bg-white dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700">
            <CardContent className="p-0 text-center">
              ...
              <div className="max-w-2xl mx-auto space-y-3 text-sm text-slate-600 dark:text-zinc-300 leading-relaxed">
                <p>
                  Created by a Muslim developer who understood the need for a private, respectful way to track spiritual accountability.
                  Every feature is designed with Islamic principles and your privacy in mind.
                </p>
              </div>
