...
export default function Dashboard() {
  ...
  const { data: counterTrendData } = useTrendData(30);
  ...
  const [activeTab, setActiveTab] = useState<"counter" | "checker" | "trends">(
    "counter"
  );
          ...
          <div className="flex space-x-1 py-2 xs:py-3">
            {tabs.map((tab) => (
              <button
                key={tab.id}
                onClick={() =>
                  setActiveTab(tab.id as "counter" | "checker" | "trends")
                }
                className={`
                    ...
                    <div className="bg-gradient-to-r from-slate-50 to-slate-100 dark:from-zinc-800 dark:to-zinc-900 rounded-xl p-4 xs:p-5 border border-slate-200 dark:border-zinc-700">
                      ...
                      <div className="mt-3 pt-3 border-t border-slate-200 dark:border-zinc-600">
                        <p className="text-xs text-slate-600 dark:text-zinc-400 flex items-start gap-1">
                          ...
                          <span>
                            For educational purposes. Consult qualified scholars
                                ...
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-xs text-slate-600 dark:text-zinc-400">
                                      {verificationResult.evidence.length}{" "}
                                      scholarly{" "}
                                ...
                                <div className="mb-4 p-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800">
                                  <div className="flex gap-2">
                                    ...
                                    <p className="text-xs text-amber-700 dark:text-amber-300">
                                      <strong>Research Encouragement:</strong>{" "}
                                      These sources present various scholarly
                                      perspectives. Cross-reference with
                                      additional sources and consult qualified
                                      Islamic scholars for comprehensive
                                      understanding.
                                    </p>
                                  </div>
                                </div>
                ...
                <div className="flex gap-1 xs:gap-2 mt-3 xs:mt-4 overflow-x-auto pb-2 scrollbar-hide">
                  {[
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        setSelectedPeriod(period.value as TrendPeriod)
                      }
